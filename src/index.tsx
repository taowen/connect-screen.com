      ...
      <main>
        ...
        <details>
          ...
          <ul>
            ...
            屏易连-1.6.3
              <ul>
                <li>修复 y700 无法单应用投屏的问题</li>
                <li>增加 displaylink 输出刷新率的设置</li>
              </ul>
            </li>
            <li>
              屏易连-1.6.2
            ...
            屏易连-1.6.0
              <ul>
                ...
                <li>停留在屏易连界面时阻止系统锁屏。如果需要在所有场景下都不锁屏，设置中新增了阻止锁屏的选项，用 shizuku 权限帮你改锁屏的超时时间</li>
                <li>自动隐藏的悬浮返回按键会在熄屏亮屏时短暂恢复一下，帮助你找到自动隐藏悬浮返回键的位置</li>
              </ul>
            </li>
            <li>
            屏易连-1.5.9
            ...
            屏易连-1.5.5
              <ul>
                <li>修复安卓14无法熄屏的问题</li>
                <li>修复退出按钮不能立即退出moonlight无线投屏的问题</li>
              </ul>
            </li>
            <li>
            屏易连-1.5.4
