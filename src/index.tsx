...
app.get('/', (c) => {
  ...
  <h1>安卓屏连功能说明</h1>
  <h2>软件获取</h2>
  <p>安卓屏连目前仍然处于开发中的状态，最新版本的 apk 请进入 QQ 群 577902537 获取。或者在 QQ 中搜索“安卓屏连”。</p>
  <h2>为什么要开发安卓屏连</h2>
  <ul>
    <li>USB 2.0 手机通过 displaylink 连7寸16:9的便携屏当掌机用，解决比例造成的黑边。解决触控屏不好使的问题。竖屏旋转成横屏。</li>
    <li>USB 3.0 手机直连7寸16:9的便携屏当掌机用，解决比例造成的黑边。提供触控板</li>
    <li>手机连大便携屏投高德地图当车机用</li>
    <li>小屏幕的车机外接一个更大的扩展屏</li>
    <li>手机带到公司插上显示器，当办公pc用</li>
...
所以拓展手机的更多用法不是台式机带去星巴克的行为艺术，那是对你身体的进一步扩展。
  </p>
  <h2>已经实现的功能</h2>
  <ul>
